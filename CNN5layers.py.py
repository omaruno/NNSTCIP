...
model.save('EccettoPrimaInc.h5')

"""
['idle', 'walk-stairascent', 'stairascent', 'stairascent-walk', 
'walk-stairdescent', 'stairdescent', 'stairdescent-walk', 
'walk-rampascent', 'rampascent', 'rampascent-walk', 'walk-rampdescent', 
'rampdescent', 'rampdescent-walk', 'treadmill']
 """
