...
from keras.layers import LSTM, Dense, Conv1D, MaxPooling1D, Flatten, Attention
from keras.models import Sequential
from keras.layers import LSTM, Dense, Dropout, Attention
from tensorflow.keras.layers import Input, LSTM, Conv1D, MaxPooling1D, Flatten, Dense, Attention, Multiply
