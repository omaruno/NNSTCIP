...
from keras.layers import Conv1D, MaxPooling1D, Flatten, Dense, LSTM, BatchNormalization
...
model = keras.Sequential([
    layers.LSTM(128, return_sequences=True, input_shape=(100, 24)),
...
model.save('LSTM_CNN_Lineare.h5')
